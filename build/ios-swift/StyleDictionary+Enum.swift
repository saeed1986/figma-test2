...
// Generated on Mon, 05 Feb 2024 14:28:06 GMT


import UIKit

public enum StyleDictionaryEnum {
    public static let collection1Mode1Blue100 = #2d69c2
    public static let collection1Mode1Color = #ffffff
    public static let collection1Mode1Green100 = #2d890d
    public static let collection1Mode1Orange = #f68b27
    public static let collection1Mode1Red100 = #ff1616
    ...
    public static let globalBlue100 = #0028ff
    public static let globalGreen100 = #00972d
    public static let globalRed100 = #f00
    public static let globalSm = 4
